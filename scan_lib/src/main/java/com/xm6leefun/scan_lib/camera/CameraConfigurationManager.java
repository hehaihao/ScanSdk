...
//    if (ScanCodeActivity.surfaceView_width!=0&&ScanCodeActivity.surfaceView_height!=0) {
//      Camera.Size optionSize = getOptimalPreviewSize(sizeList, ScanCodeActivity.surfaceView_width, ScanCodeActivity.surfaceView_height);//获取一个最为适配的屏幕尺寸
