...
public final class ViewfinderView extends View {
    ...
    public ViewfinderView(Context context, AttributeSet attrs) {
        ...
        laserColor = array.getColor(R.styleable.ViewfinderView_laser_color, 0x00FF00);  // 扫描线颜色
        cornerColor = array.getColor(R.styleable.ViewfinderView_corner_color, getResources().getColor(R.color.black222));  // 四角颜色
        frameColor = array.getColor(R.styleable.ViewfinderView_frame_color, 0xFFFFFF);  // 扫描区域边框颜色
        resultPointColor = array.getColor(R.styleable.ViewfinderView_result_point_color, 0xC0FFFF00);  // 扫描点的颜色
        maskColor = array.getColor(R.styleable.ViewfinderView_mask_color, 0x60000000);  // 模糊区域颜色
        resultColor = array.getColor(R.styleable.ViewfinderView_result_color, 0xB0000000);
        labelTextColor = array.getColor(R.styleable.ViewfinderView_label_text_color, 0x90FFFFFF);  //扫描区域提示文本颜色
        labelText = array.getString(R.styleable.ViewfinderView_label_text);
        bottomText = array.getString(R.styleable.ViewfinderView_bottom_text);
        bottomTextColor = array.getColor(R.styleable.ViewfinderView_bottom_text_color, 0x90FFFFFF);  //扫描区域提示文本颜色
        labelTextSize = array.getFloat(R.styleable.ViewfinderView_label_text_size, 36f);
        bottomTextSize = array.getFloat(R.styleable.ViewfinderView_bottom_text_size, 36f);
...
//            drawTextInfo(canvas, frame);
            drawBottomTextInfo(canvas, frame);
    ...
    //绘制文本
    private void drawBottomTextInfo(Canvas canvas, Rect frame) {
        if (!TextUtils.isEmpty(bottomText)) {
            paint.setColor(bottomTextColor);
            paint.setTextSize(bottomTextSize);
            paint.setTextAlign(Paint.Align.CENTER);
            canvas.drawText(bottomText, frame.left + frame.width() / 2, frame.bottom + CORNER_RECT_HEIGHT*4, paint);
        }
    }
