...
//      framingRect = new Rect(leftOffset, topOffset-150, leftOffset + width, topOffset + height-150);
////      int i = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 150,
////              HelpUtils.activity.getResources().getDisplayMetrics());
////      framingRect = new Rect(leftOffset, 30, leftOffset + width, i-10);
//      Log.d(TAG, "Calculated framing rect: " + framingRect);
//    }
//    return framingRect;
//  }
...
//      rect.bottom = rect.bottom * cameraResolution.y / screenResolution.y;
   ...
   * @return A PlanarYUVLuminanceSources instance.
   */
  public PlanarYUVLuminanceSources buildLuminanceSource(byte[] data, int width, int height) {
    ...
    switch (previewFormat) {
      ...
      case PixelFormat.YCbCr_422_SP:
        return new PlanarYUVLuminanceSources(data, width, height, rect.left, rect.top,
