...
package com.xm6leefun.scan_lib.zxing.oned.rss.expanded;

import com.xm6leefun.scan_lib.zxing.BarcodeFormat;
import com.xm6leefun.scan_lib.zxing.DecodeHintType;
import com.xm6leefun.scan_lib.zxing.FormatException;
...
import com.xm6leefun.scan_lib.zxing.common.BitArray;
import com.xm6leefun.scan_lib.zxing.oned.rss.AbstractRSSReader;
import com.xm6leefun.scan_lib.zxing.oned.rss.DataCharacter;
import com.xm6leefun.scan_lib.zxing.oned.rss.FinderPattern;
import com.xm6leefun.scan_lib.zxing.oned.rss.RSSUtils;
import com.xm6leefun.scan_lib.zxing.oned.rss.expanded.decoders.AbstractExpandedDecoder;
...
public final class RSSExpandedReader extends AbstractRSSReader {
  ...
  private final List<com.xm6leefun.scan_lib.zxing.oned.rss.expanded.ExpandedPair> pairs = new ArrayList<>(MAX_PAIRS);
  ...
  public Result decodeRow(int rowNumber,
    ...
    try {
      List<com.xm6leefun.scan_lib.zxing.oned.rss.expanded.ExpandedPair> pairs = decodeRow2pairs(rowNumber, row);
  ...
  List<com.xm6leefun.scan_lib.zxing.oned.rss.expanded.ExpandedPair> decodeRow2pairs(int rowNumber, BitArray row) throws NotFoundException {
    try {
      while (true){
        com.xm6leefun.scan_lib.zxing.oned.rss.expanded.ExpandedPair nextPair = retrieveNextPair(row, this.pairs, rowNumber);
    ...
    if (tryStackedDecode) {
      ...
      List<com.xm6leefun.scan_lib.zxing.oned.rss.expanded.ExpandedPair> ps = checkRows(false);
      if (ps != null) {
        return ps;
      }
      ps = checkRows(true);
  ...
  private List<com.xm6leefun.scan_lib.zxing.oned.rss.expanded.ExpandedPair> checkRows(boolean reverse) {
    ...
    List<com.xm6leefun.scan_lib.zxing.oned.rss.expanded.ExpandedPair> ps = null;
    try {
  ...
  private List<com.xm6leefun.scan_lib.zxing.oned.rss.expanded.ExpandedPair> checkRows(List<ExpandedRow> collectedRows, int currentRow) throws NotFoundException {
  ...
  private static boolean isValidSequence(List<com.xm6leefun.scan_lib.zxing.oned.rss.expanded.ExpandedPair> pairs) {
  ...
  private static void removePartialRows(List<com.xm6leefun.scan_lib.zxing.oned.rss.expanded.ExpandedPair> pairs, List<ExpandedRow> rows) {
    for (Iterator<ExpandedRow> iterator = rows.iterator(); iterator.hasNext(); ) {
      ...
      for (com.xm6leefun.scan_lib.zxing.oned.rss.expanded.ExpandedPair p : r.getPairs()) {
        boolean found = false;
        for (com.xm6leefun.scan_lib.zxing.oned.rss.expanded.ExpandedPair pp : pairs) {
          if (p.equals(pp)) {
            found = true;
            break;
          }
  ...
  private static boolean isPartialRow(Iterable<com.xm6leefun.scan_lib.zxing.oned.rss.expanded.ExpandedPair> pairs, Iterable<ExpandedRow> rows) {
    for (ExpandedRow r : rows) {
      boolean allFound = true;
      for (com.xm6leefun.scan_lib.zxing.oned.rss.expanded.ExpandedPair p : pairs) {
        boolean found = false;
        for (com.xm6leefun.scan_lib.zxing.oned.rss.expanded.ExpandedPair pp : r.getPairs()) {
          if (p.equals(pp)) {
            found = true;
            break;
          }
  ...
  static Result constructResult(List<com.xm6leefun.scan_lib.zxing.oned.rss.expanded.ExpandedPair> pairs) throws NotFoundException, FormatException {
    BitArray binary = com.xm6leefun.scan_lib.zxing.oned.rss.expanded.BitArrayBuilder.buildBitArray(pairs);
  ...
  private boolean checkChecksum() {
    com.xm6leefun.scan_lib.zxing.oned.rss.expanded.ExpandedPair firstPair = this.pairs.get(0);
    ...
    for(int i = 1; i < this.pairs.size(); ++i){
      com.xm6leefun.scan_lib.zxing.oned.rss.expanded.ExpandedPair currentPair = this.pairs.get(i);
  ...
  // not private for testing
  com.xm6leefun.scan_lib.zxing.oned.rss.expanded.ExpandedPair retrieveNextPair(BitArray row, List<com.xm6leefun.scan_lib.zxing.oned.rss.expanded.ExpandedPair> previousPairs, int rowNumber)
    ...
    return new com.xm6leefun.scan_lib.zxing.oned.rss.expanded.ExpandedPair(leftChar, rightChar, pattern, mayBeLast);
  }

  private void findNextPair(BitArray row, List<com.xm6leefun.scan_lib.zxing.oned.rss.expanded.ExpandedPair> previousPairs, int forcedOffset)
      throws NotFoundException {
    ...
    if (forcedOffset >= 0) {
      ...
      com.xm6leefun.scan_lib.zxing.oned.rss.expanded.ExpandedPair lastPair = previousPairs.get(previousPairs.size() - 1);
