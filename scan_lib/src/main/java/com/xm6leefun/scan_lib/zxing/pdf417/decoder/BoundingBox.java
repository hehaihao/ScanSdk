...
final class BoundingBox {
  ...
  BoundingBox(com.xm6leefun.scan_lib.zxing.pdf417.decoder.BoundingBox boundingBox) {
  ...
  static com.xm6leefun.scan_lib.zxing.pdf417.decoder.BoundingBox merge(com.xm6leefun.scan_lib.zxing.pdf417.decoder.BoundingBox leftBox, com.xm6leefun.scan_lib.zxing.pdf417.decoder.BoundingBox rightBox) throws NotFoundException {
    if (leftBox == null) {
      return rightBox;
    }
    if (rightBox == null) {
    ...
    return new com.xm6leefun.scan_lib.zxing.pdf417.decoder.BoundingBox(leftBox.image, leftBox.topLeft, leftBox.bottomLeft, rightBox.topRight, rightBox.bottomRight);
  }

  com.xm6leefun.scan_lib.zxing.pdf417.decoder.BoundingBox addMissingRows(int missingStartRows, int missingEndRows, boolean isLeft) throws NotFoundException {
    ...
    calculateMinMaxValues();
    return new com.xm6leefun.scan_lib.zxing.pdf417.decoder.BoundingBox(image, newTopLeft, newBottomLeft, newTopRight, newBottomRight);
  }
