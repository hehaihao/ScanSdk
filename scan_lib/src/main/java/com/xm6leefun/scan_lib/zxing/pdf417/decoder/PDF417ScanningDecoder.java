...
import com.xm6leefun.scan_lib.zxing.ChecksumException;
...
import com.xm6leefun.scan_lib.zxing.common.BitMatrix;
import com.xm6leefun.scan_lib.zxing.common.DecoderResult;
import com.xm6leefun.scan_lib.zxing.pdf417.PDF417Common;
import com.xm6leefun.scan_lib.zxing.pdf417.decoder.ec.ErrorCorrection;
...
public final class PDF417ScanningDecoder {
  ...
  public static DecoderResult decode(BitMatrix image,
    ...
    com.xm6leefun.scan_lib.zxing.pdf417.decoder.BoundingBox boundingBox = new com.xm6leefun.scan_lib.zxing.pdf417.decoder.BoundingBox(image, imageTopLeft, imageBottomLeft, imageTopRight, imageBottomRight);
    com.xm6leefun.scan_lib.zxing.pdf417.decoder.DetectionResultRowIndicatorColumn leftRowIndicatorColumn = null;
    com.xm6leefun.scan_lib.zxing.pdf417.decoder.DetectionResultRowIndicatorColumn rightRowIndicatorColumn = null;
    ...
    for (int barcodeColumnCount = 1; barcodeColumnCount <= maxBarcodeColumn; barcodeColumnCount++) {
      ...
      if (barcodeColumn == 0 || barcodeColumn == maxBarcodeColumn) {
        detectionResultColumn = new com.xm6leefun.scan_lib.zxing.pdf417.decoder.DetectionResultRowIndicatorColumn(boundingBox, barcodeColumn == 0);
      } else {
  ...
  private static DetectionResult merge(com.xm6leefun.scan_lib.zxing.pdf417.decoder.DetectionResultRowIndicatorColumn leftRowIndicatorColumn,
                                       com.xm6leefun.scan_lib.zxing.pdf417.decoder.DetectionResultRowIndicatorColumn rightRowIndicatorColumn)
    ...
    com.xm6leefun.scan_lib.zxing.pdf417.decoder.BoundingBox boundingBox = com.xm6leefun.scan_lib.zxing.pdf417.decoder.BoundingBox.merge(adjustBoundingBox(leftRowIndicatorColumn),
        adjustBoundingBox(rightRowIndicatorColumn));
    return new DetectionResult(barcodeMetadata, boundingBox);
  }

  private static com.xm6leefun.scan_lib.zxing.pdf417.decoder.BoundingBox adjustBoundingBox(com.xm6leefun.scan_lib.zxing.pdf417.decoder.DetectionResultRowIndicatorColumn rowIndicatorColumn)
      throws NotFoundException, FormatException {
  ...
  private static BarcodeMetadata getBarcodeMetadata(com.xm6leefun.scan_lib.zxing.pdf417.decoder.DetectionResultRowIndicatorColumn leftRowIndicatorColumn,
                                                    com.xm6leefun.scan_lib.zxing.pdf417.decoder.DetectionResultRowIndicatorColumn rightRowIndicatorColumn) {
  ...
  private static com.xm6leefun.scan_lib.zxing.pdf417.decoder.DetectionResultRowIndicatorColumn getRowIndicatorColumn(BitMatrix image,
                                                                                                         com.xm6leefun.scan_lib.zxing.pdf417.decoder.BoundingBox boundingBox,
                                                                                                         ResultPoint startPoint,
                                                                                                         boolean leftToRight,
                                                                                                         int minCodewordWidth,
                                                                                                         int maxCodewordWidth) {
    com.xm6leefun.scan_lib.zxing.pdf417.decoder.DetectionResultRowIndicatorColumn rowIndicatorColumn = new com.xm6leefun.scan_lib.zxing.pdf417.decoder.DetectionResultRowIndicatorColumn(boundingBox,
        leftToRight);
    for (int i = 0; i < 2; i++) {
  ...
  private static Codeword detectCodeword(BitMatrix image,
    ...
    int decodedValue = com.xm6leefun.scan_lib.zxing.pdf417.decoder.PDF417CodewordDecoder.getDecodedValue(moduleBitCount);
