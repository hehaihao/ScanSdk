...
public final class PDF417 {
  ...
  private static void encodeChar(int pattern, int len, com.xm6leefun.scan_lib.zxing.pdf417.encoder.BarcodeRow logic) {
    int map = 1 << len - 1;
  ...
  public void generateBarcodeLogic(String msg, int errorCorrectionLevel) throws WriterException {
    ...
    int errorCorrectionCodeWords = com.xm6leefun.scan_lib.zxing.pdf417.encoder.PDF417ErrorCorrection.getErrorCorrectionCodewordCount(errorCorrectionLevel);
    String highLevel = com.xm6leefun.scan_lib.zxing.pdf417.encoder.PDF417HighLevelEncoder.encodeHighLevel(msg, compaction, encoding);
    ...
    String ec = com.xm6leefun.scan_lib.zxing.pdf417.encoder.PDF417ErrorCorrection.generateErrorCorrection(dataCodewords, errorCorrectionLevel);
