...
package com.xm6leefun.scan_lib.zxing.oned.rss;
...
public final class RSS14Reader extends AbstractRSSReader {
  ...
  private final List<com.xm6leefun.scan_lib.zxing.oned.rss.Pair> possibleLeftPairs;
  private final List<com.xm6leefun.scan_lib.zxing.oned.rss.Pair> possibleRightPairs;
  ...
  public Result decodeRow(int rowNumber,
    ...
    com.xm6leefun.scan_lib.zxing.oned.rss.Pair leftPair = decodePair(row, false, rowNumber, hints);
    addOrTally(possibleLeftPairs, leftPair);
    row.reverse();
    com.xm6leefun.scan_lib.zxing.oned.rss.Pair rightPair = decodePair(row, true, rowNumber, hints);
    addOrTally(possibleRightPairs, rightPair);
    row.reverse();
    int lefSize = possibleLeftPairs.size();
    for (int i = 0; i < lefSize; i++) {
      com.xm6leefun.scan_lib.zxing.oned.rss.Pair left = possibleLeftPairs.get(i);
      if (left.getCount() > 1) {
        int rightSize = possibleRightPairs.size();
        for (int j = 0; j < rightSize; j++) {
          com.xm6leefun.scan_lib.zxing.oned.rss.Pair right = possibleRightPairs.get(j);
          if (right.getCount() > 1) {
  ...
  private static void addOrTally(Collection<com.xm6leefun.scan_lib.zxing.oned.rss.Pair> possiblePairs, com.xm6leefun.scan_lib.zxing.oned.rss.Pair pair) {
    if (pair == null) {
      return;
    }
    boolean found = false;
    for (com.xm6leefun.scan_lib.zxing.oned.rss.Pair other : possiblePairs) {
  ...
  private static Result constructResult(com.xm6leefun.scan_lib.zxing.oned.rss.Pair leftPair, com.xm6leefun.scan_lib.zxing.oned.rss.Pair rightPair) {
  ...
  private static boolean checkChecksum(com.xm6leefun.scan_lib.zxing.oned.rss.Pair leftPair, com.xm6leefun.scan_lib.zxing.oned.rss.Pair rightPair) {
  ...
  private com.xm6leefun.scan_lib.zxing.oned.rss.Pair decodePair(BitArray row, boolean right, int rowNumber, Map<DecodeHintType,?> hints) {
    try {
      ...
      return new com.xm6leefun.scan_lib.zxing.oned.rss.Pair(1597 * outside.getValue() + inside.getValue(),
